...
void ArrayTester::testPrint() {
	...
	print(a3, 5);
        cleanup();
	cout << "\nPassed!" << endl;
} // This test function tests the print.
...
void ArrayTester::testAverage() {
	...
	assert( average(a3, 5) == 5 );
        cleanup();
	cout << "Passed!" << endl;
} // This test function tests the average.
...
void ArrayTester::testSum() {
	...
	assert( sum(a3, 5) == 25 );
        cleanup();
	cout << "Passed!" << endl;
} // This test function tests the sum.
...
} // This test function tests the resize of the array.
...
void ArrayTester::testFill() {
	...
	for (unsigned i = 0; i < size1; i++) {
        ...
        cleanup();
	cout << "Passed!  But double-check that you deleted the old array..." << endl;
} // This test function tests filling in the array.
...
void ArrayTester::testRead() {
	...
	cout << "Passed!" << endl;
} // This test function tests reading from a text file.
