...
/* Overload operator
 * @param: ostream out
 * values are printed out in the console
 * with the euqal sign.
 * AUTHORED BY: Hansol Kim (hk94)
 */
 ...
 * @param: string otherPersonName
 * inputs yourName anywhere
 * the user inputs after
 * the otherPersonsName.
 * AUTHORED BY: Hansol Kim (hk94)
 */
template <class Item>
 ...
 * insert yourName anywhere
 * the user inputs before
 * the otherPersonsName.
 * AUTHORED BY: Hansol Kim (hk94)
 */
template <class Item>
